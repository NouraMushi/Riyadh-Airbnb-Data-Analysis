...
# average_ratings_quarter = df.groupby(['city_quarter'], as_index=False)['rating'].mean().sort_values(by='rating', ascending=False)


# highest_rating_quarter = average_ratings_quarter.loc[average_ratings_quarter['rating'].idxmax()]


# print(average_ratings_quarter)
# print(f"The city quarter with the highest average rating is {highest_rating_quarter['city_quarter']} with an average rating of {highest_rating_quarter['rating']:.2f}.")

# average_ratings_quarter = average_ratings_quarter.dropna()


# fig = px.bar(average_ratings_quarter,
#              x='city_quarter',
#              y='rating',
#              title='Average Ratings by City Quarter',
#              labels={'rating': 'Average Rating', 'city_quarter': 'City Quarter'},
#              color='rating',
#              color_continuous_scale=px.colors.sequential.Plasma)
